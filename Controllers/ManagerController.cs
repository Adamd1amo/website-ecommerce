...
namespace DoAn1.Controllers
{
    public class ManagerController : Controller
    {
        ...
        public ManagerController(DoAn1Context context)
        {
            _context = context;
        }
        ...
        {
            return View(_context.sqlMDetailProduct(ProductId));
        }
        [HttpPost]
        public IActionResult EditProduct(int ProductId, double Price, string Description, string AgentName)
        {
            return View();
        }
